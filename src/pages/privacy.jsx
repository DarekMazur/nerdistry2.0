				...
				<ol>
					<li>
						...
						<ol>
							...
							<li>
								The operator of the service and the Administrator of personal
								data is: Nerdistry
							</li>
							<li>
					...
					<li>
						...
						<ol>
							...
							<li>
								...
								such that only those holding the Operator&apos;s key can read
								it. Thus, the data is protected in case the database is stolen
								from the server.
							</li>
							<li>
								User passwords are stored in hashed form. The hash function
								works unidirectionally - it is not possible to reverse its
								operation, which is now the modern standard for storing user
								passwords.
							</li>
							<li>
							...
							<li>
								In order to protect the data, the Operator regularly makes
								backups security.
							</li>
							<li>
								An important element of data protection is the regular updating
								of any software used by the Operator to processing personal
								data, which in particular means regular updates of software
								components.
							</li>
						</ol>
					</li>
					...
					<li>
						...
						<ol>
							<li>
								In certain situations, the Administrator has the right to
								transfer your personal data to other recipients, if it is
								necessary to perform a contract concluded with you or to fulfill
								obligations incumbent on the Administrator. This applies to such
								groups of recipients: o a hosting company on a trust basis o
								authorized employees and co-workers who use the data in order to
							...
							<li>
								...
								by separate regulations (e.g., on the conduct of accounting).
								With regard to marketing data, the data will not will be
							...
							<li>
								...
								the Administrator, including profiling, whereby whereby the
								right to object will not be exercisable in the event of there
								are valid legitimate grounds for processing, overriding your
								interests, rights and freedoms freedoms, in particular to
								establish, assert or defend claims.
							</li>
							<li>
								The actions of the Administrator may be complained about to the
								President of the Office ofProtection of Personal Data, ul.
							...
							<li>
								The following actions may be taken in relation to youon
								automated decision-making, including profiling for the for the
								purpose of providing services under the concluded agreement and
								for the purpose of conducting direct marketing by the
								Administrator.
							</li>
							<li>
					...
					<li>
						...
						<ol>
							<li>
								The service collects information voluntarily provided by the
								user, including including personal information, if provided.
							</li>
							<li>
							...
							<li>
								...
								the association of the data in the form with the e-mail address
								of the of the user filling out the form. In such a case, the
								e-mail address of the user appears inside the url of the page
								containing the form.
							</li>
							<li>
								The data provided in the form is processed for the purpose
								resulting from the function of a specific form, e.g. for the
								purpose of performing the process of handling a service request
								or commercial contact, registration of services, etc. Each time
								the context and description of the form in a clearly informs
								what it is used for.
							</li>
						</ol>
					</li>
					...
					<li>
						...
						<ol>
							<li>
								...
								through Google Analytics (Google Inc., based in the USA). The
								operator does not transmits personal data to the operator of
								this service, but only anonymized information. The service is
								based on the use of cookies on the user&apos;s terminal device.
								In terms of information about the user&apos;s preferences
								collected by the Google advertising network, the user can view
								and edit the information resulting from cookies using{' '}
								<a
					...
					<li>
						...
						<ol>
							...
							<li>
								...
								off software (web browser). &quot;Permanent&quot; cookies
								cookies are stored on the User&apos;s end device for the the
								time specified in the parameters of the cookies or until they
							...
							<li>
								...
								on this subject can be found in the help or documentation of
								your web browser.
							</li>
							<li>
					...
					<li>
						...
						<ol>
							<li>
								If you do not want to receive cookies, you can change your
								browser settings. We stipulate that disabling handling of
								cookies necessary for the processes of authentication, security,
								maintaining user preferences user may make it more difficult,
								and in extreme cases may make it impossible to use the websites
							</li>
							<li>
								To manage your cookie settings, select from the list below the
								web browser you are using and follow the instructions:
								<ul>
									<li>Edge</li>
